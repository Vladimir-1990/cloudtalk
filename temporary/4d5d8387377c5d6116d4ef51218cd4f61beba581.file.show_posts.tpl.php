<?php /* Smarty version Smarty-3.0.7, created on 2013-09-17 22:10:01
         compiled from "C:\wamp\www\cloudtalk\libraries/../themes\show_posts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62765238b71977c8e9-58965186%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d5d8387377c5d6116d4ef51218cd4f61beba581' => 
    array (
      0 => 'C:\\wamp\\www\\cloudtalk\\libraries/../themes\\show_posts.tpl',
      1 => 1379435776,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '62765238b71977c8e9-58965186',
  'function' => 
  array (
  ),
...
&nbsp;</a>
                <?php }?>
                <p class="twit_text">
                    <?php $_smarty_tpl->assign('post' , insert_prepare_post (array('value' => 'var', 'twit' => $_smarty_tpl->getVariable('twits')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['content']),$_smarty_tpl), true);?>
...
"><?php echo $_smarty_tpl->getVariable('username')->value;?>
                ...
                <?php }?>
                <?php if ($_smarty_tpl->getVariable('twits')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['reply_to']!='0'){?>
                    <a class="reposted" href="status.php?id=<?php echo $_smarty_tpl->getVariable('twits')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['reply_to'];?>
">View conversation</a>
                <?php }?>
